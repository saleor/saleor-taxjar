...
export const createTaxJarOrder = async (  order: OrderSubscriptionFragment,
  taxJarConfig: TaxJarConfig) => {
    const countryCode = order.shippingAddress?.country.code || order.billingAddress!.country.code;
